...
type RegisterResponse struct {
	...
	ExpiresIn     int64                  `protobuf:"varint,4,opt,name=expires_in,json=expiresIn,proto3" json:"expires_in,omitempty"` // секунды до истечения access_token
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type LoginRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// email или username — один идентификатор на MVP
...
const file_auth_v1_auth_proto_rawDesc = "" +
	...
	"\x06Logout\x12\x16.auth.v1.LogoutRequest\x1a\x17.auth.v1.LogoutResponseB*Z(auth-service/internal/gen/auth/v1;authv1b\x06proto3"
